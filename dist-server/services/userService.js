...
var UserService = exports.UserService = /*#__PURE__*/function () {
  ...
  return _createClass(UserService, [{
    ...
    key: "loadUserById",
    value: function () {
      var _loadUserById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var userById;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _user["default"].findById(id).exec();
            case 2:
              ...
              return _context2.abrupt("return", userById);
            case 7:
      ...
      function loadUserById(_x) {
        return _loadUserById.apply(this, arguments);
      }
      return loadUserById;
    }()
  }, {
    key: "loadUserByName",
    value: function () {
      var _loadUserByName = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name) {
        var userById;
      ...
      function loadUserByName(_x2) {
        return _loadUserByName.apply(this, arguments);
      }
    ...
    key: "updateUser",
    value: function () {
      var _updateUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(userObject) {
        var newUser, userResult, updatedUser;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              newUser = new _user["default"](userObject);
              _context4.next = 4;
              return newUser.save();
            case 4:
            ...
            case 8:
              _context4.next = 10;
              return _user["default"].findByIdAndUpdate(userObject._id, userObject, {});
            case 10:
